...
class Calculator:
    def __init__(self, master):
        ...
        Button(width=11, height=4, text='=', relief='flat', bg="light blue", command=lambda:self.solve()).place(x= 270, y= 350)
